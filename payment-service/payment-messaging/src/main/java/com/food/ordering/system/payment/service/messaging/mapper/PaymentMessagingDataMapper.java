...
public class PaymentMessagingDataMapper {
    ...
    paymentCompletedEventToPaymentResponseModel(PaymentCompletedEvent paymentCompletedEvent) {
    ...
    public PaymentResponseModel
    paymentCancelledEventToPaymentResponseModel(PaymentCancelledEvent paymentCancelledEvent) {
        return PaymentResponseModel.builder()
                .id(UUID.randomUUID())
                .sagaId(UUID.randomUUID())
    ...
    public PaymentResponseModel
    paymentFailedEventToPaymentResponseModel(PaymentFailedEvent paymentFailedEvent) {
        return PaymentResponseModel.builder()
                .id(UUID.randomUUID())
                .sagaId(UUID.randomUUID())
